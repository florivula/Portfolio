	...
	return (
		<section id="work" className="py-12 sm:py-20 px-4 bg-white scroll-mt-20">
			<div className="max-w-6xl mx-auto">
				<h2 className="text-2xl sm:text-3xl font-bold mb-8 sm:mb-12 text-center text-gray-900">Industry Experience</h2>
					...
					{[
						...
						>
							<div className="p-6 sm:p-8 space-y-4 sm:space-y-6">
								...
								<p className="text-xs text-gray-500 italic">{project.note}</p>
							</div>
						</div>
					))}
				</div>
